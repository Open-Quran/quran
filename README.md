...
* `flutter.compileSdkVersion = 31`
##### 5. Download google-service.json file from the firebase refer to: [Firebase Doc](https://support.google.com/firebase/answer/7015592?hl=en#zippy=%2Cin-this-article)
